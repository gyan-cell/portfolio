    ...
    <div id="about">
      ...
      <div className={`additionalSection ${itim.className}`}  >
        <div className='setup'  >
          ...
          <p className={itim.className}  >GPU : <Link target='_blank' href="https://www.zotac.com/mk/product/graphics_card/zotac-gaming-geforce-rtx-3060-twin-edge-oc-0https://www.zotac.com/mk/product/graphics_card/zotac-gaming-geforce-rtx-3060-twin-edge-oc-0"> Zotac Rtx 3060 Gddr6 12Gb 192Bit Pcie 4.0 | 3584 CUDA CORES  </Link> </p>

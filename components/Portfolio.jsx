...
import style from "../styles/portfolio.scss";
                ...
                <SwiperSlide>
                  <div className="projectCard">
                    <div className="details">
                      <div className="name">
                        <div className="rn">
                          Projects / {items.name} using {items.technology}
                        </div>
                      </div>
